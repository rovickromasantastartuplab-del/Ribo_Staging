                ...
                <tr>
                    ...
                    <td class="header-cell">
                        <table style="width: 100%;">
                            ...
                            <tr>
                                <td></td>
                                <td class="text-right" style="padding-left: 10px; color: #333;">Valid Until:
                                    {{ $quote->valid_until ? \Carbon\Carbon::parse($quote->valid_until)->format('M d, Y') : '-' }}
                                </td>
                            </tr>
                        </table>
                    </td>
            ...
            <table class="info-table">
                <tr>
                    <td>
                        ...
                        <p>
                            @if($quote->account) {{ $quote->account->name }}<br> @endif
                            @if($quote->billingContact)
                                {{ $quote->billingContact->name }}<br>
                                {{ $quote->billingContact->email }}<br>
                                {{ $quote->billingContact->phone }}<br>
                            @endif
                    ...
                    <td class="text-right">
                        ...
                        <p>
                            @if($quote->shippingContact)
                                {{ $quote->shippingContact->name }}<br>
                                {{ $quote->shippingContact->email }}<br>
                                {{ $quote->shippingContact->phone }}<br>
                            @endif
