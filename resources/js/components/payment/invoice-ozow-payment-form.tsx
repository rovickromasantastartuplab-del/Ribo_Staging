...
export function InvoiceOzowPaymentForm({
  invoiceId,
  amount,
  paymentType,
  ozowSiteKey,
    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <Alert>
          <AlertCircle className="h-4 w-4" />
          <AlertDescription>
            {t('You will be redirected to Ozow to complete your payment securely.')}
          </AlertDescription>
        </Alert>
        ...
        <div className="text-xs text-muted-foreground text-center">
          {t('Powered by Ozow - South Africa\'s instant EFT payment gateway')}
        </div>
      </CardContent>
    </Card>
  );
