...
interface InvoiceAuthorizeNetPaymentFormProps {
  invoiceId: number;
  amount: number;
  paymentType: string;
...
export function InvoiceAuthorizeNetPaymentForm({
  invoiceId,
  amount,
  paymentType,
  ...
  onSuccess,
  onCancel,
}: InvoiceAuthorizeNetPaymentFormProps) {
  ...
  const handlePayment = async () => {
    ...
    router.post(route('invoice.authorizenet.payment'), {
