              ...
              <div className="relative z-10 flex flex-col h-full p-6 pt-8">
                ...
                <div className="mb-4">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <div className="bg-white/50 rounded-lg p-2 text-center">
                      ...
                      <div className="text-xs text-muted-foreground">{t('Accounts')}</div>
                    </div>
                    <div className="bg-white/50 rounded-lg p-2 text-center col-span-2">
                      <div className="text-lg font-bold" style={{ color: brandColor }}>
                ...
                <div className="mt-auto pt-4 border-t border-gray-200">
                  <Link
                    ...
                    style={{
                      backgroundColor: plan.is_popular ? brandColor : 'rgb(243, 244, 246)',
                      color: plan.is_popular ? 'white' : 'rgb(17, 24, 39)'
                    }}
                  >
