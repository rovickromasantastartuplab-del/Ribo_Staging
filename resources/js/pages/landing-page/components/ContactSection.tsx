      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8 sm:mb-12 lg:mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
            {sectionData?.title || t('Connect with Sales SaaS')}
          </h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed font-medium">
            {sectionData?.subtitle || t('Have questions about Sales SaaS? Our team is here to help you succeed.')}
          </p>
        </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                  <div>
                    <label htmlFor="name" className="block text-sm font-medium text-gray-700 mb-2">
                      {t('Full Name')} <span className="text-red-500" aria-label={t('required')}>*</span>
                    </label>
                    <input
                      type="text"
                      id="name"
                  ...
                  <div>
                    <label htmlFor="email" className="block text-sm font-medium text-gray-700 mb-2">
                      {t('Email Address')} <span className="text-red-500" aria-label={t('required')}>*</span>
                    </label>
                    <input
                      type="email"
                      id="email"
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-600 mb-8">
                  {sectionData?.info_description || t('We\'re here to help and answer any question you might have. We look forward to hearing from you.')}
                </p>
              </div>
