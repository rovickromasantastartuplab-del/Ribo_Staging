export const defaultLandingPageSections = {
  sections: [
    ...
    },
    {
      ...
      members: [
        { name: 'Sarah Johnson', role: 'CEO & Founder', bio: 'Sales strategist and former tech executive with 15+ years of experience in scaling SaaS businesses.', image: '', linkedin: '#', email: 'sarah@sales.com' },
        { name: 'Michael Lee', role: 'CTO', bio: 'Full-stack engineer specializing in Laravel and React with a passion for building scalable SaaS platforms.', image: '', linkedin: '#', email: 'michael@sales.com' },
        { name: 'Priya Sharma', role: 'Head of Product', bio: 'Product leader focused on delivering user-friendly sales solutions that solve real-world challenges.', image: '', linkedin: '#', email: 'priya@sales.com' },
        { name: 'David Kim', role: 'Head of Marketing', bio: 'Growth marketer with expertise in SaaS positioning, customer acquisition, and brand strategy.', image: '', linkedin: '#', email: 'david@sales.com' }
      ]
    },
    {
      key: 'testimonials',
      ...
      benefits: [
        {
          ...
          description: 'Proven sales strategies and SaaS growth hacks'
        },
        {
          icon: '🚀',
        ...
        },
        {
          ...
          description: 'Learn how to optimize sales with actionable analytics'
        }
      ]
    },
    {
