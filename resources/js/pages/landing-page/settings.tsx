                  ...
                  <div className="grid grid-cols-1 gap-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <Input
                        ...
                        placeholder={t("🚀 Smart Reports & Advanced Analytics")}
                      />
                      <p className="text-xs text-muted-foreground">
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex gap-2">
                            <Input
                              ...
                              placeholder={t("Businesses Powered")}
                            />
                            <Button
                              type="button"
                              variant="outline"
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    <div className="space-y-3">
                      ...
                      <Input
                        ...
                        placeholder={t("See Our Sales SaaS in Action")}
                      />
                    </div>
                        ...
                        <div className="grid grid-cols-1 gap-4">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="space-y-3">
                              ...
                              <Input
                                ...
                                placeholder={t("Sales SaaS Dashboard Overview")}
                              />
                            </div>
                          </div>
                          ...
                          <div className="space-y-3">
                            ...
                            <Textarea
                              ...
                              placeholder={t("Get a complete view of leads, employees, projects, sales, projects, and performance insights in one place.")}
                              rows={2}
                            />
                          </div>
                        </div>
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    <div className="space-y-3">
                      ...
                      <Input
                        ...
                        placeholder={t("Why Choose Our Sales SaaS?")}
                    ...
                    <div className="space-y-3">
                      ...
                      <Textarea
                        ...
                        placeholder={t("We\'re more than just CRM — we\'re your complete sales growth platform.")}
                        rows={3}
                      />
                    </div>
                  </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                          ...
                          <div className="space-y-3 md:col-span-1">
                            ...
                            <Textarea
                              ...
                              placeholder={t("Get started in minutes with a user-friendly interface and ready-to-use modules.")}
                              rows={3}
                            />
                          </div>
                        </div>
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <Textarea
                        ...
                        placeholder={t("We are a passionate group of sales experts, developers, and innovators building the future of sales automation.")}
                        rows={3}
                      />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <Textarea
                        ...
                        placeholder={t("We are always looking for talented individuals to help us shape the next generation of sales technology.")}
                        rows={3}
                      />
                    </div>
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <Textarea
                        ...
                        placeholder={t("Don\'t just take our word for it — hear from businesses using our Sales SaaS.")}
                        rows={3}
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="space-y-3">
                      ...
                      <Input
                        ...
                        placeholder={t("Trusted by Businesses Worldwide")}
                      />
                    </div>
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <Textarea
                        ...
                        placeholder={t("Everything you need to know before getting started.")}
                        rows={3}
                      />
                    </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <Input
                        ...
                        placeholder={t("Didn’t find your answer?")}
                      />
                    </div>
                        ...
                        <div className="space-y-4">
                          <div className="space-y-3">
                            ...
                            <Input
                              ...
                              placeholder={t("What makes this SaaS different from others?")}
                            />
                          </div>
                          ...
                          <div className="space-y-3">
                            ...
                            <Textarea
                              ...
                              placeholder={t("Unlike other tools, our platform is built to help you grow faster. With powerful automation, real-time analytics, and world-class support, you’ll get results from day one.")}
                              rows={3}
                            />
                          </div>
                        </div>
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    <div className="space-y-3">
                      ...
                      <Input
                        ...
                        placeholder={t("Stay Updated with Sales SaaS")}
                      />
                    </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <Textarea
                        ...
                        placeholder={t("Get the latest sales strategies, product updates, and growth insights.")}
                        rows={3}
                      />
                    </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <Input
                        ...
                        placeholder={t("We value your privacy — no spam, unsubscribe anytime.")}
                      />
                    </div>
                  </div>
                </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                          ...
                          <div className="space-y-3">
                            ...
                            <Input
                              ...
                              placeholder={t("Proven sales strategies and SaaS growth hacks")}
                            />
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    <div className="space-y-3">
                      ...
                      <Input
                        ...
                        placeholder={t("Connect with Sales SaaS")}
                      />
                    </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <Textarea
                        ...
                        placeholder={t("Have questions about Sales SaaS? Our team is here to help you succeed.")}
                        rows={3}
                      />
                    </div>
                      ...
                      <div key={category} className="space-y-4">
                        <div className="space-y-3">
                          ...
                          <Input
                            ...
                            placeholder={t(category.charAt(0).toUpperCase() + category.slice(1))}
                          />
                        </div>
                        <h4 className="font-medium">{getSectionData('footer').section_titles?.[category] || t(category.charAt(0).toUpperCase() + category.slice(1))} {t('Links')}</h4>
                        ...
                        >
                          <Plus className="h-4 w-4 mr-2" />
                          {t("Add")} {getSectionData('footer').section_titles?.[category] || t(category.charAt(0).toUpperCase() + category.slice(1))} {t("Link")}
                        </Button>
                      </div>
                    ))}
                  </div>
