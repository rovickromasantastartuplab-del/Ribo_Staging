...
export default function OpportunitySources() {
  ...
  const handleBulkAction = (action: string, selectedIds: any[]) => {
    if (action === 'bulk_delete') {
      if (!hasPermission(permissions, 'delete-opportunity-sources')) {
      ...
      if (confirm(t('Are you sure you want to delete the selected {{count}} records? This action cannot be undone.', { count: selectedIds.length }))) {
        ...
        router.delete(route('opportunity-sources.bulk-delete'), {
  ...
  // Add the "Add New Opportunity Source" button if user has permission
