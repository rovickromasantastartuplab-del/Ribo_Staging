...
export default function Template2({ quote, items, taxesData, settings, color, qr_invoice, qrCodeSvg, styles: externalStyles }: Template2Props) {
                ...
                <div className="invoice-header" style={styles.invoiceHeader}>
                    ...
                    <table className="vertical-align-top" style={styles.headerTable}>
                        <tbody>
                            <tr>
                                <td style={styles.headerCell}>
                                    <h3 style={{ textTransform: 'uppercase', fontSize: '25px', fontWeight: 'bold', marginBottom: '15px' }}>{t('QUOTE')}</h3>
                                    <table className="no-space" style={{ width: '100%' }}>
                                        <tbody>
                                            <tr>
                                                <td style={{ ...styles.noSpace }}>{t('Number')}: {formatValue(quote.quote_number)}</td>
                                            </tr>
                                            <tr>
                                                <td style={{ ...styles.noSpace }}>{t('Valid Until')}: {formatValue(quote.valid_until)}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </td>
                    ...
                    <table className="add-border invoice-summary" style={{ ...styles.table, marginTop: '30px' }}>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style={{ ...styles.td, borderBottom: `1px solid ${borderColor}` }}>{quote.totalQuantity}</td>
