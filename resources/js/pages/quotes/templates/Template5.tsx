...
export default function Template5({ quote, items, taxesData, settings, color, qr_invoice, qrCodeSvg, styles: externalStyles }: Template5Props) {
                        ...
                        <tr>
                            <td style={{ padding: '15px 30px', verticalAlign: 'top' }}>
                                ...
                                <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                                    <tbody>
                                        <tr>
                                            <td style={{ padding: '0' }}>{t('Number')}: {formatValue(quote.quote_number)}</td>
                                        </tr>
                                        <tr>
                                            <td style={{ padding: '0' }}>{t('Valid Until')}: {formatValue(quote.valid_until)}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </td>
