...
export default function Template10({ quote, items, taxesData, settings, color, qr_invoice, qrCodeSvg, styles: externalStyles }: Template10Props) {
                        ...
                        <tr style={{ verticalAlign: 'top' }}>
                            <td style={{ padding: '0', verticalAlign: 'top' }}>
                                <p style={{ margin: '0', lineHeight: '1.5' }}>
                                    <b style={{ color: borderColor }}>{t('FROM')}:</b><br />
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style={{ padding: '0', textAlign: 'right', fontSize: '13px', fontWeight: '600' }}>
                                                <b>{t('Number')}:</b> {formatValue(quote.quote_number)}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style={{ padding: '0', fontSize: '13px', fontWeight: '600', color: `#${color}` }}></td>
                                            <td style={{ padding: '0', textAlign: 'right', fontSize: '13px', fontWeight: '600' }}>
                                                <b>{t('Valid Until')}:</b> {formatValue(quote.valid_until)}
                                            </td>
                                        </tr>
                                        <tr>
