...
export default function WeddingSuppliers() {
  ...
  const handleBulkAction = (action: string, selectedIds: any[]) => {
    if (action === 'bulk_delete') {
      if (!hasPermission(permissions, 'delete-wedding-suppliers')) {
  ...
  const handleBulkDeleteConfirm = () => {
    ...
    router.delete(route('wedding-suppliers.bulk-delete'), {
  ...
  const handleDeleteConfirm = () => {
            ...
            render: (value: any, row: any) => {
                return (
                    <div className="flex items-center gap-3">
                        <div className="flex shrink-0 h-10 w-10 items-center justify-center rounded-full bg-primary/10 text-primary">
    ...
    return (
      ...
      <CrudDeleteModal
        ...
        entityName={t('wedding suppliers')}
      />
            {/*test */}
