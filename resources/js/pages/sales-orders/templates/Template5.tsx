...
export default function Template5({ salesOrder, items, taxesData, settings, color, qr_invoice, qrCodeSvg, styles: externalStyles }: Template5Props) {
                        ...
                        <tr>
                            <td style={{ padding: '15px 30px', verticalAlign: 'top' }}>
                                ...
                                <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                                    <tbody>
                                        <tr>
                                            <td style={{ padding: '0' }}>{t('Number')}: {formatValue(salesOrder.sales_order_number)}</td>
                                        </tr>
                                        <tr>
                                            <td style={{ padding: '0' }}>{t('Order Date')}: {formatValue(salesOrder.order_date)}<br />{t('Delivery Date')}: {formatValue(salesOrder.delivery_date)}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </td>
