...
export default function Template5({ invoice, items, taxesData, settings, color, qr_invoice, qrCodeSvg, styles: externalStyles }: Template5Props) {
                        ...
                        <tr>
                            <td style={{ padding: '15px 30px', verticalAlign: 'top' }}>
                                ...
                                <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                                    <tbody>
                                        <tr>
                                            <td style={{ padding: '0' }}>{t('Number')}: {formatValue(invoice.invoice_number)}</td>
                                        </tr>
                                        <tr>
                                            <td style={{ padding: '0' }}>{t('Invoice Date')}: {formatValue(invoice.invoice_date)}<br />{t('Due Date')}: {formatValue(invoice.due_date)}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </td>
