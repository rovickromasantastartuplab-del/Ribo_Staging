                        ...
                        <tbody>
                            <tr>
                                <td style={styles.headerCell}>
                                    <h3 style={{ textTransform: 'uppercase', fontSize: '20px', fontWeight: 'bold' }}>{t('INVOICE')}</h3>
                                    ...
                                    <table className="no-space" style={{ width: '100%' }}>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td className="text-right" style={{ ...styles.noSpace, textAlign: 'right' }}>{t('Number')}: {formatValue(invoice.invoice_number)}</td>
                                            </tr>
                                            <tr>
                                                <td style={styles.noSpace}></td>
                                                <td className="text-right" style={{ ...styles.noSpace, textAlign: 'right' }}>{t('Invoice Date')}: {formatValue(invoice.invoice_date)}<br />{t('Due Date')}: {formatValue(invoice.due_date)}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </td>
                    ...
                    <table style={styles.table}>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style={{ ...styles.td, borderBottom: `1px solid ${borderColor}` }}>{formatCurrency(invoice.total_discount || 0)}</td>
