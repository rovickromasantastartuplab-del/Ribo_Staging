...
export default function Settings() {
    ...
    const { systemSettings = {}, cacheSize = '0.00', timezones = {}, dateFormats = {}, timeFormats = {}, paymentSettings = {}, webhooks = [], auth = {}, socialAccounts = [] } = usePage().props as any;
                ...
                <div className="flex-1">
                    ...
                    {(auth.permissions?.includes('settings') || auth.roles?.includes('company')) && (
                        <section id="integrations-settings" ref={integrationsSettingsRef} className="mb-8">
                            <IntegrationsSettings settings={systemSettings} socialAccounts={socialAccounts} />
                        </section>
                    )}
