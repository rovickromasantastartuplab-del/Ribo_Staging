import{r,j as o,s as l}from"./ui-Cd7I_VH9.js";const m=r.forwardRef(({children:i},a)=>{const t=r.useRef(null),[n,d]=r.useState(null);return r.useImperativeHandle(a,()=>({print:()=>{if(!t.current)return;const e=t.current.contentWindow;e.focus(),e.print()}})),r.useEffect(()=>{if(!t.current)return;const e=t.current.contentDocument;e.open(),e.write(`
                <!DOCTYPE html>
                <html>
                    <head>
                        <style>
