import{j as e}from"./ui-Dj1c1pwa.js";import{K as l}from"./app-D-oNljZa.js";import"./utils-DCj7OOX3.js";function m(){const{invoice:i,templateId:c,templateColor:d,settings:t}=l().props;t!=null&&t.defaultCurrency;const a=r=>`${r.toFixed(2)}`,n=r=>new Date(r).toLocaleDateString();return e.jsxs("html",{children:[e.jsxs("head",{children:[e.jsx("meta",{charSet:"utf-8"}),e.jsx("meta",{name:"viewport",content:"width=device-width, initial-scale=1"}),e.jsx("style",{dangerouslySetInnerHTML:{__html:`
                        body {
