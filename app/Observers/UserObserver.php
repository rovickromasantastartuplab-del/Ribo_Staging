...
class UserObserver
{
    ...
    {
        // Generate a unique numeric referral code for company users if not already set
        if (($user->type === 'company' || $user->type === 'superadmin' || $user->type === 'super admin') && !$user->referral_code) {
            do {
